...
class DiGraph:
    ...
    # 
    def load(self):
        path_json = "%s%s" % (self._directory_data, self._name)
        ...
        #for v in temp:
          #for u in temp[v]:
            #print "temp:",v,u
       # for v in self._data:
        #  for u in self._data[v]:
            #print "self._data",v,u
